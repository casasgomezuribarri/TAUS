...
source("TAUS/taus.r") # loads dependencies and custom functions
...
# datasets were named in order of analysis
# examples were named in order of appearance in the thesis (simpler to more complex)
...
if (dataset == "simu") {
  surv <- read.csv("Data/synth/simu.csv") # dataset
  ...
  surv_tmp <- read.csv("Data/online/dros1.csv") # dataset
  ...
  surv_tmp <- read.csv("Data/online/dros2.csv") # dataset
...
ggsave(plot = f_t, paste0("/Users/ivancasas/GitHub/Thesis/Chapters/02_TAUS/pics/", plot_names, "_histograms.png"), width = 6.5, height = 7, dpi = 400)
...
ggsave(plot = km_curves_emp, paste0("/Users/ivancasas/GitHub/Thesis/Chapters/02_TAUS/pics/", plot_names, "_KMcurves.png"), width = 6.5, height = 7, dpi = 400)
...
# we need to deinf n p and f for the dros datasets
if (dataset == "simu") {
...
ggsave(plot = plot, paste0("/Users/ivancasas/GitHub/Thesis/Chapters/02_TAUS/pics/", plot_names, "_KMcurves_with_parametric.png"), width = 6.5, height = 4.5, dpi = 400)
...
ggsave(plot = plot_clean, paste0("/Users/ivancasas/GitHub/Thesis/Chapters/02_TAUS/pics/", plot_names, "_KMcurves_with_parametric_cleaner.png"), width = 6.5, height = 4.5, dpi = 400)
...
if (dataset == "simu") {
  ...
  ggsave(plot = p, paste0("/Users/ivancasas/GitHub/Thesis/Chapters/02_TAUS/pics/", plot_names, "_PowerAnalysisAt.png"), width = 6.5, height = 4.5, dpi = 400)
}
...
ggsave(plot = cond_surv_heatmap, paste0("/Users/ivancasas/GitHub/Thesis/Chapters/02_TAUS/pics/", plot_names, "_heatmaps.png"), width = 6.5, height = 4.5, dpi = 400)
...
ggsave(plot = cond_surv_line, paste0("/Users/ivancasas/GitHub/Thesis/Chapters/02_TAUS/pics/", plot_names, "_P(T>", tau_value, "|T>t).png"), width = 6.5, height = 4.5, dpi = 400)
...
if (dataset == "simu") { # square
  ggsave(plot = cond_surv_curve, paste0("/Users/ivancasas/GitHub/Thesis/Chapters/02_TAUS/pics/", plot_names, "_P(T>tau).png"), width = 6.5, height = 4.5, dpi = 400)
} else if (dataset == "dros1") {
  ggsave(plot = cond_surv_curve, paste0("/Users/ivancasas/GitHub/Thesis/Chapters/02_TAUS/pics/", plot_names, "_P(T>tau).png"), width = 6.5, height = 4.5, dpi = 400)
} else if (dataset == "dros2") {
  ggsave(plot = cond_surv_curve, paste0("/Users/ivancasas/GitHub/Thesis/Chapters/02_TAUS/pics/", plot_names, "_P(T>tau).png"), width = 6.5, height = 4.5, dpi = 400)
...
ggsave(plot = cond_surv_scatter, paste0("/Users/ivancasas/GitHub/Thesis/Chapters/02_TAUS/pics/", plot_names, "_P(T>", tau_value, ").png"), width = 6.5, height = 4.5, dpi = 400)
...
if (dataset == "simu") {
  ...
  ggsave(plot = cond_surv_scatter2, paste0("/Users/ivancasas/GitHub/Thesis/Chapters/02_TAUS/pics/", plot_names, "_P(T>taus).png"), width = 6.5, height = 4.5, dpi = 400)
}
